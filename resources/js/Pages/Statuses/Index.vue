                                            ...
                                            >
                                                ...
                                                <template slot="table-row" slot-scope="props">
                                                    <span v-if="props.column.field == 'actions'">
                                                     ...
                                                     <a :href="'/dashboard/statuses/'+props.row.id+'/edit'" title="Редактировать" class="badge badge-warning">
    ...
    methods: {
        delete_record: function (id) {
            ...
            this.$swal({
                ...
                if (isConfirm === true) {
                    axios.delete(route("statuses.destroy", id))
                        .then(
                            (response) => {
                                const index = this.statuses.map(status => status.id).indexOf(id);
